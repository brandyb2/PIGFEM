...
int main (int argc, char* argv[])
{
	...
	// add all of the sensitivity parameters
	...
	for (id_type inc=0; inc<mesh.n_inclusions(); ++inc)
	{
		...
		for (id_type param = 0; param<names.size(); ++param)
		{
			...
			// Run the low problem
			PIGFEMPrint("RUNNING THE LOW PROBLEM FOR " << names[param] << inc);
			...
			PIGFEMPrint("RUNNING THE HIGH PROBLEM FOR " << names[param] << inc);
	...
	} // b SensitivityShapeParameter.cpp:46
	...
	PIGFEMPrint("RUNNING THE SENSITIVITY PROBLEM");
