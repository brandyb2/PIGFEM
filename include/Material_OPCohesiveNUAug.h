...
##################################################################################
*/
#ifndef _NU_OP_AUG_COH_MATERIAL_H_
#define _NU_OP_AUG_COH_MATERIAL_H_
 ...
 */
class OPCohesiveNUAugMaterial : public Material
{
	protected:
	...
	public:
		OPCohesiveNUAugMaterial();
		virtual ~OPCohesiveNUAugMaterial() {};

		// Main constitutive subroutine
		virtual Material::output_params* Constitutive(Material::input_params& input);

		// Helper functions
		virtual material_type get_type() {return OP_COHESIVE_NO_UNLOADING_AUGMENTED;};
