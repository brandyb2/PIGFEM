...
##################################################################################
*/
#ifndef _SENSITIVITY_SHAPE_PARAMETER_THERMAL_H_
#define _SENSITIVITY_SHAPE_PARAMETER_THERMAL_H_
#include "SensitivityShapeParameter.h"


class SensitivityShapeParameterThermal : public SensitivityShapeParameter
{
	public:
