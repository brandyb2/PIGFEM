...
##################################################################################
*/
#ifndef _PLANE_INCLUSION_H_
#define _PLANE_INCLUSION_H_


#include "Inclusion.h"

class Plane_Inclusion : public Inclusion
{
	private:
	...
	public:
		Plane_Inclusion();
		Plane_Inclusion(Plane_Inclusion & other_inc);
		virtual ~Plane_Inclusion();
		...
		virtual std::vector<double> find_intersection(std::vector<Node>& nodes, double& alpha);
