...
##################################################################################
*/
#ifndef _COH_QUAD4_H_
#define _COH_QUAD4_H_
...
class CohQuad4 : public CohesiveElem
{
	public:
		CohQuad4();
		CohQuad4(std::vector<Node*> nodes, id_type id);
		
		// Element defintion
		id_type n_nodes() const {return 8;};
		id_type dim() const {return 2;};
		coh_elem_type get_type() const {return COHQUAD4;};
...
inline
CohQuad4::CohQuad4(std::vector<Node*> nodes, id_type id)
