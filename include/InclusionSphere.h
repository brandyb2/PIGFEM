...
##################################################################################
*/
#ifndef _SPHERE_INCLUSION_H_
#define _SPHERE_INCLUSION_H_


#include "Inclusion.h"

class Sphere_Inclusion : public Inclusion
{
	private:
		std::vector<double> _center;
		double _r;		// major axis radius

	public:
		Sphere_Inclusion();
		Sphere_Inclusion(Sphere_Inclusion & other_inc);
		~Sphere_Inclusion();
		...
		virtual inclusion_type get_type() {return SPHERE;};
