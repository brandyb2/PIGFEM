...
##################################################################################
*/
#ifndef _NONLINEAR_STRUCTURAL_THERMALPRELOAD_H_
#define _NONLINEAR_STRUCTURAL_THERMALPRELOAD_H_

#include "ProblemNonlinear.h"

class ProblemNonlinearStructural_ThermalPreLoad : public ProblemNonlinear
{
	public:
		ProblemNonlinearStructural_ThermalPreLoad();
		virtual ~ProblemNonlinearStructural_ThermalPreLoad() {};
