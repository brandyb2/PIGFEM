...
##################################################################################
*/
#ifndef _BL_COH_MATERIAL_H_
#define _BL_COH_MATERIAL_H_
 ...
 *	no-unloading class
 */
class BilinearCohesiveMaterial : public BilinearCohesiveNUMaterial
{
	public:
		virtual ~BilinearCohesiveMaterial() {};

		// Main constitutive subroutine
		virtual Material::output_params* Constitutive(Material::input_params& input);

		// Helper functions
		virtual material_type get_type() {return BL_COHESIVE;};
