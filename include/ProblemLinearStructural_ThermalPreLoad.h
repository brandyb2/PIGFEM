...
##################################################################################
*/
#ifndef _LINEAR_STRUCTURAL_THERMALPRELOAD_H_
#define _LINEAR_STRUCTURAL_THERMALPRELOAD_H_

#include "ProblemLinear.h"

class ProblemLinearStructural_ThermalPreLoad : public ProblemLinear
{
	public:
		ProblemLinearStructural_ThermalPreLoad();
		virtual ~ProblemLinearStructural_ThermalPreLoad() {};
