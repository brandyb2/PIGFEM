...
enum material_type {
	...
	OP_COHESIVE_AUGMENTED,
	OP_COHESIVE_NO_UNLOADING_AUGMENTED,
	...
	BL_COHESIVE,
	BL_COHESIVE_NO_UNLOADING,
	TL_COHESIVE,
	TL_COHESIVE_NO_UNLOADING};
...
enum problem_type {
	...
	NONLINEAR_STRUCTURAL_THERMALPRELOAD,
	LINEAR_STRUCTURAL_THERMALPRELOAD};
