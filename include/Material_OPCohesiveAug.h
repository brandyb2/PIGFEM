...
##################################################################################
*/
#ifndef _OP_AUG_COH_MATERIAL_H_
#define _OP_AUH_COH_MATERIAL_H_
 ...
 *	no-unloading class
 */
class OPCohesiveAugMaterial : public OPCohesiveNUAugMaterial
{
	public:
		virtual ~OPCohesiveAugMaterial() {};

		// Main constitutive subroutine
		virtual Material::output_params* Constitutive(Material::input_params& input);

		// Helper functions
		virtual material_type get_type() {return OP_COHESIVE_AUGMENTED;};
