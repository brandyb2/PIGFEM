...
ProblemNonlinearStructural_ThermalPreLoad::ProblemNonlinearStructural_ThermalPreLoad()
...
void ProblemNonlinearStructural_ThermalPreLoad::generate_assembler()
{
...
id_type ProblemNonlinearStructural_ThermalPreLoad::nndof()
{
	return _mesh->dim();
}

// Returns the problem type enum for this problem
problem_type ProblemNonlinearStructural_ThermalPreLoad::get_type()
{
	return NONLINEAR_STRUCTURAL_THERMALPRELOAD;
}

// Set any possible problem specific parameters
void ProblemNonlinearStructural_ThermalPreLoad::set_parameter(std::string name, double val)
{
...
double ProblemNonlinearStructural_ThermalPreLoad::get_parameter(std::string name)
{
	std::transform(name.begin(), name.end(), name.begin(), ::toupper); // Capitilize the name
	if (name=="PLANE_STRAIN" || name=="PLANE STRAIN")
	{
...
void ProblemNonlinearStructural_ThermalPreLoad::fillBmat(DenseMatrix<double>& B, const std::vector<std::vector<double> >& grad_x)
{
...
void ProblemNonlinearStructural_ThermalPreLoad::solve_problem()
{
